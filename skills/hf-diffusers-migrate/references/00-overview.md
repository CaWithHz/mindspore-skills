...
- **MindOne Diffusers**: MindSpore-based adaptation by MindSpore Lab, compatible with HF v0.35.2
...
MindOne diffusers is compatible with **HuggingFace diffusers v0.35.2** and provides preview support for SoTA v0.36 pipelines.
